...
| `nodeGroups[name].image`                         | Worker OS image source for this node group. Default (omitted): import over HTTP from the cluster-wide talos.* Image Factory. Set `image.builtin` to clone a golden from the opt-in worker image catalog instead. Editing this on an existing group re-images that group.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `object`            | `{}`        |
| `nodeGroups[name].image.builtin`                 | Clone a golden image from the worker image catalog.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `*object`           | `null`      |
| `nodeGroups[name].image.builtin.schematicID`     | Talos schematic ID of the golden to clone. Defaults to the cluster-wide talos.schematicID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `string`            | `""`        |
| `nodeGroups[name].image.builtin.version`         | Talos version of the golden to clone. Defaults to the cluster-wide talos.version.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `string`            | `""`        |
| `nodeGroups[name].image.factory`                 | Import from an Image Factory / mirror (default).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `*object`           | `null`      |
| `nodeGroups[name].image.factory.version`         | Talos version. Defaults to the cluster-wide talos.version.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `string`            | `""`        |
| `nodeGroups[name].image.factory.schematicID`     | Talos schematic ID. Defaults to the cluster-wide talos.schematicID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `string`            | `""`        |
| `nodeGroups[name].image.factory.imageFactoryURL` | Base URL of the Image Factory serving the boot raw image. Defaults to the cluster-wide talos.imageFactoryURL. No trailing slash. NOTE: this redirects only the worker boot-disk import; the in-guest upgrade installer image is always sourced from the cluster-wide talos.installerRepository, so an air-gapped node group must also have talos.installerRepository pointed at a reachable registry.                                                                                                                                                                                                                                                                                                                                                                                                                           | `string`            | `""`        |
